...
export type $OpenApiTs = {
  ...
  "/api/v1/analysis/dep": {
    get: {
      req: SearchComponentDepsData;
      res: {
        /**
         * Search component(s) and return their deps.
         */
        "200": DepSummary;
      };
    };
  ...
  "/api/v1/analysis/dep/{key}": {
    get: {
      req: GetComponentDepsData;
      res: {
        /**
         * Retrieve component(s) dep components by name or pURL.
         */
        "200": DepSummary;
      };
    };
  ...
  "/api/v1/analysis/root-component": {
    get: {
      req: SearchComponentRootComponentsData;
      res: {
        /**
         * Search component(s) and return their root components.
         */
        "200": AncestorSummary;
      };
    };
  ...
  "/api/v1/analysis/root-component/{key}": {
    get: {
      req: GetComponentRootComponentsData;
      res: {
        /**
         * Retrieve component(s) root components by name or pURL.
         */
        "200": AncestorSummary;
      };
    };
  ...
  "/api/v1/license": {
    get: {
      req: ListLicensesData;
      res: {
        /**
         * Matching licenses
         */
        "200": PaginatedLicenseSummary;
      };
    };
  };
  "/api/v1/license/spdx/license": {
    get: {
      req: ListSpdxLicensesData;
      res: {
        /**
         * Matching licenses
         */
        "200": PaginatedSpdxLicenseSummary;
      };
    };
  };
  "/api/v1/license/spdx/license/{id}": {
    get: {
      req: GetSpdxLicenseData;
      res: {
        /**
